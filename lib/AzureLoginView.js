...
import { MEDIUMSLATEBLUE } from "../src/colors";
...
export default class AzureLoginView extends Component {
  ...
  async _handleTokenRequest(e): any {
    // get code when url changes
    const url = e.url
if(e.uri && e.uri.loading) {
  ...
  render() {
    ...
    return this.state.visible ? (
      <WebView
        ...
        renderLoading={() => <ActivityIndicator size="large" color={ MEDIUMSLATEBLUE } style={StyleSheet.absoluteFill} /> }
